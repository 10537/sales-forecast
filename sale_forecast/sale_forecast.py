		...
		for index,item in enumerate(periods):
			...
			for product in product_ids:
				...
				vals = {
					...
					'avg_qty':avg_qty,
					'avg_sale_qty':round(avg_sale_qty),
...
# {'origin': u'SO028', 'product_uos_qty': 1.0, 'product_uom': 3, 'warehouse_id': 1, 'route_ids': [], 'product_qty': 1.0, 'product_uos': 3, 'location_id': 9, 
# 'product_id': 56, 'property_ids': [(6, 0, [])], 'partner_dest_id': 7, 'name': u'[1] Ice Cream', 'sale_line_id': 43, 
# 'date_planned': '2015-03-30 05:44:22', 'company_id': 1, 'invoice_state': 'none', 'group_id': 39}
